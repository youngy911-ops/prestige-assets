      ...
      {showBranchPicker ? (
        ...
        <>
          ...
          <button
            ...
            className="w-full flex flex-col items-center justify-center gap-3 rounded-2xl border-2 border-dashed border-emerald-500/35 bg-emerald-500/[7%] hover:bg-emerald-500/10 hover:border-emerald-500/50 text-white min-h-[160px] transition-all disabled:opacity-50 shadow-[inset_0_0_30px_rgba(16,185,129,0.05)]"
          >
