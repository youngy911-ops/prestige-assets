    ...
    <>
      ...
      <div className="print:hidden max-w-2xl mx-auto px-4 pt-6 pb-4 flex items-center justify-between">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 bg-emerald-500 hover:bg-emerald-400 text-white text-sm font-bold px-4 py-2 rounded-xl transition-all shadow-[0_0_0_1px_rgba(52,211,153,0.3)] hover:shadow-[0_0_0_1px_rgba(52,211,153,0.5)]"
        >
