...
const TEST_ASSETS: TestAsset[] = [
  ...
  // --- VEHICLES ---
  {
    asset_type: 'vehicle', asset_subtype: 'dual_cab_ute',
    fields: { make: 'Toyota', model: 'Hilux', variant: 'SR5', year: '2021', vin: 'MROFR22G900123456', registration_number: '123ABC', odometer: '68400', colour: 'White', engine_type: '2.8L 4-Cylinder Turbo Diesel', fuel_type: 'Diesel', transmission: 'Automatic', drive_type: '4WD', body_type: 'Dual Cab Ute', driveable: 'Yes', master_key: 'Yes', spare_key: 'No', damage: 'Minor scratches to tray sides, stone chips to bonnet', damage_notes: 'Tray Sides - Minor scratches from loading\nBonnet - Stone chips along leading edge\nDriver Rear Quarter - Light scratch' },
  },
  {
    asset_type: 'vehicle', asset_subtype: 'suv',
    fields: { make: 'Mazda', model: 'CX-5', variant: 'Akera', year: '2022', vin: 'JM3KFBDM3N0654321', registration_number: 'XYZ789', odometer: '34200', colour: 'Soul Red Crystal', engine_type: '2.5L 4-Cylinder Turbo Petrol', fuel_type: 'Petrol', transmission: 'Automatic', drive_type: 'AWD', body_type: 'SUV', driveable: 'Yes', master_key: 'Yes', spare_key: 'Yes' },
  },
  {
    asset_type: 'vehicle', asset_subtype: 'van',
    fields: { make: 'Toyota', model: 'HiAce', variant: 'SLWB', year: '2020', vin: 'JTFSX23P800098765', odometer: '124500', colour: 'White', engine_type: '2.8L 4-Cylinder Turbo Diesel', fuel_type: 'Diesel', transmission: 'Automatic', drive_type: '2WD', body_type: 'Van', driveable: 'Yes', master_key: 'Yes', spare_key: 'No', damage: 'Scratches and dents visible around vehicle, cargo area scuffed', damage_notes: 'Sliding Door LHS - Dent approx 100mm\nRear Bumper - Scuff marks and scrapes\nRoof - Minor hail dents' },
  },
  {
    asset_type: 'vehicle', asset_subtype: 'hatchback',
    fields: { make: 'Hyundai', model: 'i30', variant: 'Active', year: '2023', vin: 'KMHGC41E9PU112233', registration_number: 'DEF456', odometer: '15800', colour: 'Silver', engine_type: '2.0L 4-Cylinder', fuel_type: 'Petrol', transmission: 'CVT', drive_type: '2WD', body_type: 'Hatchback', driveable: 'Yes', master_key: 'Yes', spare_key: 'Yes', service_history: 'Full Log Books', owners_manual: 'Yes' },
  },
  {
    asset_type: 'vehicle', asset_subtype: '4wd',
    fields: { make: 'Nissan', model: 'Patrol', variant: 'Y62 Ti-L', year: '2019', vin: 'JN1TBNY62Z0543210', odometer: '87600', colour: 'Black', engine_type: '5.6L V8 Petrol', fuel_type: 'Petrol', transmission: 'Automatic', drive_type: '4WD', body_type: 'SUV / 4WD', driveable: 'Yes', master_key: 'Yes', spare_key: 'No', damage: 'Stone chips to bull bar and bonnet', damage_notes: 'Bull Bar - Stone chips and minor scratches\nBonnet - Stone chips along leading edge' },
  },
]
