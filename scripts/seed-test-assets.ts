...
const TEST_ASSETS: TestAsset[] = [
  ...
  // --- VEHICLES ---
  {
    ...
    fields: { make: 'Toyota', model: 'Hilux SR5', year: '2021', vin: 'MROFR22G900123456', registration_number: '123ABC', odometer: '68400', colour: 'White', engine_type: '2.8L 4-Cylinder Turbo Diesel', fuel_type: 'Diesel', transmission: 'Automatic', drive_type: '4WD', body_type: 'Dual Cab Ute', extras: 'Bull bar, tow bar, tonneau cover, sports bar, alloy wheels, reverse camera', body_condition: 'Good', interior_condition: 'Good', paint_condition: 'Good', rust_condition: 'None', seat_condition: 'Good', carpet_condition: 'Good', brake_condition: 'Good', tyre_driver_front: 'Good', tyre_driver_rear: 'Good', tyre_passenger_front: 'Good', tyre_passenger_rear: 'Average', tyre_spare: 'Full Size', driveable: 'Yes', airconditioned: 'Yes', master_key: 'Yes', spare_key: 'No', damage: 'Minor scratches to tray sides, stone chips to bonnet', damage_notes: 'Tray Sides - Minor scratches from loading\nBonnet - Stone chips along leading edge\nDriver Rear Quarter - Light scratch' },
  },
  {
    asset_type: 'vehicle', asset_subtype: 'suv',
    fields: { make: 'Mazda', model: 'CX-5 Akera', year: '2022', vin: 'JM3KFBDM3N0654321', registration_number: 'XYZ789', odometer: '34200', colour: 'Soul Red Crystal', engine_type: '2.5L 4-Cylinder Turbo Petrol', fuel_type: 'Petrol', transmission: 'Automatic', drive_type: 'AWD', body_type: 'SUV', extras: 'Leather interior, sunroof, heads-up display, Bose audio, 360 camera', body_condition: 'Excellent', interior_condition: 'Excellent', paint_condition: 'Excellent', rust_condition: 'None', seat_condition: 'Excellent', carpet_condition: 'Excellent', brake_condition: 'Good', tyre_driver_front: 'Good', tyre_driver_rear: 'Good', tyre_passenger_front: 'Good', tyre_passenger_rear: 'Good', tyre_spare: 'Space Saver', driveable: 'Yes', airconditioned: 'Yes', master_key: 'Yes', spare_key: 'Yes' },
  },
  {
    asset_type: 'vehicle', asset_subtype: 'van',
    fields: { make: 'Toyota', model: 'HiAce SLWB', year: '2020', vin: 'JTFSX23P800098765', odometer: '124500', colour: 'White', engine_type: '2.8L 4-Cylinder Turbo Diesel', fuel_type: 'Diesel', transmission: 'Automatic', drive_type: '2WD', body_type: 'Van', body_condition: 'Average', interior_condition: 'Average', paint_condition: 'Average', rust_condition: 'Minor', seat_condition: 'Average', carpet_condition: 'Average', brake_condition: 'Average', tyre_driver_front: 'Average', tyre_driver_rear: 'Average', tyre_passenger_front: 'Average', tyre_passenger_rear: 'Fair', tyre_spare: 'Full Size', driveable: 'Yes', airconditioned: 'Yes', master_key: 'Yes', spare_key: 'No', damage: 'Scratches and dents visible around vehicle, cargo area scuffed', damage_notes: 'Sliding Door LHS - Dent approx 100mm\nRear Bumper - Scuff marks and scrapes\nCargo Area - Floor scratched and scuffed from use\nRoof - Minor hail dents' },
  },
  {
    asset_type: 'vehicle', asset_subtype: 'sedan',
    fields: { make: 'Hyundai', model: 'i30 Active', year: '2023', vin: 'KMHGC41E9PU112233', registration_number: 'DEF456', odometer: '15800', colour: 'Silver', engine_type: '2.0L 4-Cylinder', fuel_type: 'Petrol', transmission: 'CVT', drive_type: '2WD', body_type: 'Hatchback', body_condition: 'Excellent', interior_condition: 'Excellent', paint_condition: 'Excellent', rust_condition: 'None', seat_condition: 'Excellent', carpet_condition: 'Excellent', brake_condition: 'Excellent', tyre_driver_front: 'New', tyre_driver_rear: 'New', tyre_passenger_front: 'New', tyre_passenger_rear: 'New', tyre_spare: 'Space Saver', driveable: 'Yes', airconditioned: 'Yes', master_key: 'Yes', spare_key: 'Yes', service_history: 'Full Log Books', owners_manual: 'Yes' },
  },
  {
    asset_type: 'vehicle', asset_subtype: '4wd',
    fields: { make: 'Nissan', model: 'Patrol Y62 Ti-L', year: '2019', vin: 'JN1TBNY62Z0543210', odometer: '87600', colour: 'Black', engine_type: '5.6L V8 Petrol', fuel_type: 'Petrol', transmission: 'Automatic', drive_type: '4WD', body_type: 'SUV / 4WD', extras: 'Leather, third row seats, tow bar, diff lock, roof rails, premium audio', body_condition: 'Good', interior_condition: 'Good', paint_condition: 'Good', rust_condition: 'None', seat_condition: 'Good', carpet_condition: 'Good', brake_condition: 'Good', tyre_driver_front: 'Good', tyre_driver_rear: 'Good', tyre_passenger_front: 'Good', tyre_passenger_rear: 'Average', tyre_spare: 'Full Size', driveable: 'Yes', airconditioned: 'Yes', master_key: 'Yes', spare_key: 'No', damage: 'Stone chips to bull bar and bonnet', damage_notes: 'Bull Bar - Stone chips and minor scratches\nBonnet - Stone chips along leading edge' },
  },
]
